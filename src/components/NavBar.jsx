...
export default function NavBar() {
  ...
  const linkClass = (path) => `px-3 py-2 rounded-md text-sm font-medium ${location.pathname.includes(path) ? 'bg-slate-800 text-white' : 'text-slate-100 hover:bg-slate-700'}`

  return (
    <nav className="bg-slate-900 text-white">
      <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
        <Link to="/" className="font-semibold tracking-tight">Site Pass</Link>
